...
const ProductCard: React.FC<ProductCardProps> = ({
  ...
  return (
    <div className="flex flex-col grow pb-8 w-full text-xl font-semibold leading-7 rounded-3xl border-2 border-solid bg-stone-50 border-neutral-200 max-md:mt-8">
      <img src={imageSrc} alt={name} className="w-full aspect-[1.33]" />
...
const products = [
  {
    imageSrc: "https://cdn.builder.io/api/v1/image/assets/TEMP/457abcd58d45a0b36d20f55592ac9c44de726b07ccc9157bb9a9ab632ffee1ae?apiKey=f50096866ace49c1858e31fb063ed080&",
    name: "Heirloom tomato",
    price: "$5.99 / lb",
    grownIn: "Grown in San Juan Capistrano, CA",
  },
  {
    imageSrc: "https://cdn.builder.io/api/v1/image/assets/TEMP/1f65230af54f1daaacfa8768ba1dbc2b4f61ec5c4fadf41cdcb799c4bcc9b4b7?apiKey=f50096866ace49c1858e31fb063ed080&",
    name: "Organic ginger",
    price: "$12.99 / lb",
